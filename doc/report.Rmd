...
<aside>
```{r fig1, fig.cap="Wordcloud without customized data cleaning"}
knitr::include_graphics("figs/wc_notclean.png")
```
</aside>
...
<aside>
```{r fig2, fig.cap="Wordcloud with customized data cleaning"}
knitr::include_graphics("figs/wc.png")
```
</aside>

Next, we demonstrate the effect of customized data cleaning on the business descriptions through word cloud. The figure 1 \@ref(fig:fig1) shows the word frequency of business description without customized data cleaning. The figure 1 \@ref(fig:fig2) shows the word frequency of business description without customized data cleaning, which removes non-informative words like company. 
