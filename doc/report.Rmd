...
Next, term frequency–inverse document frequency (TF-IDF) [@tfidf] transformation is used to create features. We decided to choose Hierarchical cluster as a preferred method for the clustering, since the algorithm does not require initial number of cluster as an input parameter. Also, we use `l1` distance measure, since data is very sparse. 
