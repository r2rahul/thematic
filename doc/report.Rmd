...
For the technology I used python data science stack [@scikit, @textblob, @nltk]. Besides, I used [MLflow](https://www.mlflow.org/) [@mlflow] and Snakemake [@smake] for workflow management. The source code is available on Github [https://github.com/thematic](https://github.com/thematic). 
